...
for lr in (lr):
    ...
    # testData_file = os.path.join(experimental_dir,'data.csv')
    # dfTest = pd.DataFrame({'Prediction': test_preds, 'True Label': test_target})
    # dfTest.to_csv(testData_file, index=False)
